...
export default function PoemStatusBar(props) {
    ...
    const poemDoc = Firebase.Poems.doc(props.docId);
    ...
    useEffect(() => {
        console.log("likes", props.likes.includes("hellohello"))
    ...
    return (
        <div className={classes.poemStatusBarContainer}>
            ...
            <p className={classes.stats} >comments: {props.commentsLength}</p>
        </div>
    )
}
